...
<div class="section"  style="margin-top: 100px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<div class="well">
			<h1><spring:message code="signup" /></h1>
...
<!--           </div>           -->
          <div class="panel-body">
            <form:form role="form" modelAttribute="signupForm">
              ...
              <div class="form-group">
                <form:label path="name" class="control-label" ><spring:message code="name" /></form:label>
                <form:input path="name" class="form-control" type="text"/>
                <form:errors path="name" cssClass="text-danger"/>
              </div>
              <div class="form-group">
                <form:label path="password" class="control-label" ><spring:message code="password" /></form:label>
